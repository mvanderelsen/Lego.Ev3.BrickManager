...
namespace Lego.Ev3.BrickManager
{
    ...
    public class TextFileEditorLineNumbers : System.Windows.Forms.Control
    {
        ...
        public TextFileEditorLineNumbers()
        {
            {
        ...
        private void Update_VisibleLineNumberItems()
        {
            ...
            string[] zSplit = zParent.Text.Split(System.Environment.NewLine.ToCharArray());
            ...
            else
            {
                ...
                zSplitStartLine = Math.Max(0, zParent.Text.Substring(0, zStartIndex).Split(System.Environment.NewLine.ToCharArray()).Length - 1);
